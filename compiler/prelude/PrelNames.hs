...
negateNaturalName, signumNaturalName, quotRemNaturalName, quotNaturalName,
  remNaturalName, andNaturalName, orNaturalName, xorNaturalName,
  shiftLNaturalName, shiftRNaturalName, bitNaturalName, testBitNaturalName,
  popCountNaturalName :: Name
...
negateNaturalIdKey, signumNaturalIdKey, quotRemNaturalIdKey, quotNaturalIdKey,
  remNaturalIdKey, andNaturalIdKey, orNaturalIdKey, xorNaturalIdKey,
  shiftLNaturalIdKey, shiftRNaturalIdKey, bitNaturalIdKey, testBitNaturalIdKey,
